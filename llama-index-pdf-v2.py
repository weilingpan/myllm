...
CITATION_QA_TEMPLATE = PromptTemplate(
    ...
    cite the appropriate source(s) using footnotes in the format [^1], [^2], etc. 
    Include the footnote details at the end of the response.

    Footnotes can include additional context, such as "long notes." When using long notes, 
    ...
    [^1]: [File Name].[File Extension], char idx: [start_char_idx~end_char_idx], page: [page_label]
        Additional information about the time of day.
    [^2]: [File Name].[File Extension], char idx: [start_char_idx~end_char_idx], page: [page_label]
        This is an example of a long note.
        Subsequent paragraphs are indented to show they belong to this note.
...
CITATION_REFINE_TEMPLATE = PromptTemplate(
    ...
    "Use footnotes in the format [^Number], [^Number], etc. "
    "Only cite a source when you are explicitly referencing it. "
    "Include the footnote details at the end of the response."
...
async def main():
    ...
    # custom_query = "python function寫法"
